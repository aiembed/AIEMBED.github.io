!(function () {
                ...
                polyfill: function () {
                        ...
                        (t.scroll = t.scrollTo = function () {
                            ...
                            (s.prototype.scrollIntoView = function () {
                                if (!0 !== a(arguments[0])) {
                                    ...
                                    i !== e.body
                                        ? (p.call(this, i, i.scrollLeft + o.left - s.left, i.scrollTop + o.top - s.top), "fixed" !== t.getComputedStyle(i).position && t.scrollBy({ left: s.left, top: s.top, behavior: "smooth" }))
                    ...
                    function p(i, s, l) {
                        ...
                        i === e.body ? ((a = t), (c = t.scrollX || t.pageXOffset), (h = t.scrollY || t.pageYOffset), (d = n.scroll)) : ((a = i), (c = i.scrollLeft), (h = i.scrollTop), (d = r)),
                            f({ scrollable: a, method: d, startTime: u, startX: c, startY: h, x: s, y: l });
                    }
                },
            };
        }),
            ...
            (function (e) {
                ...
                function n() {
                    ...
                    return (
                        ...
                        void 0 === window.smoothscrollPolyfill && ((window.smoothscrollPolyfill = S), window.smoothscrollPolyfill.polyfill()),
                        e
                    );
                }
                return (
    ...
    var O = (function () {
        ...
        : function (t, e) {
              for (var i, s, n = A(t), o = 1; o < arguments.length; o++) {
                  for (var l in (i = Object(arguments[o]))) E.call(i, l) && (n[l] = i[l]);
                  if (k) {
                      s = k(i);
                      for (var r = 0; r < s.length; r++) T.call(i, s[r]) && (n[s[r]] = i[s[r]]);
                  }
              }
              return n;
          };
    ...
    function V(t) {
        !(function (t) {
            ...
            if (0 === e.length) for (var i in t) B.call(t, i) && "function" == typeof t[i] && "[object Function]" == j.call(t[i]) && e.push(i);
    ...
    (V.prototype._notify = function (t) {
        ...
        (V.prototype._onWheel = function (t) {
            ...
            if (!this._lethargy || !1 !== this._lethargy.check(t)) {
                ...
                (i.deltaX = t.wheelDeltaX || -1 * t.deltaX),
                    ...
                    M.isFirefox && 1 == t.deltaMode && ((i.deltaX *= e.firefoxMultiplier), (i.deltaY *= e.firefoxMultiplier)),
        ...
        (V.prototype._bind = function () {
            M.hasWheelEvent && this.el.addEventListener("wheel", this._onWheel, this.listenerOptions),
                ...
                M.hasTouch && this.options.useTouch && (this.el.addEventListener("touchstart", this._onTouchStart, this.listenerOptions), this.el.addEventListener("touchmove", this._onTouchMove, this.listenerOptions)),
                M.hasPointer &&
                    M.hasTouchWin &&
        ...
        (V.prototype._unbind = function () {
            M.hasWheelEvent && this.el.removeEventListener("wheel", this._onWheel),
                ...
                M.hasTouch && (this.el.removeEventListener("touchstart", this._onTouchStart), this.el.removeEventListener("touchmove", this._onTouchMove)),
                M.hasPointer &&
                    M.hasTouchWin &&
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            this.isScrolling || this.isDraggingScrollbar
                                ? (this.instance.scroll[this.directionAxis] = F(this.instance.scroll[this.directionAxis], this.instance.delta[this.directionAxis], this.lerp))
                                ...
                                this.el.querySelectorAll("[data-".concat(this.name, "]")).forEach(function (e, i) {
                                    ...
                                    if (v) {
                                        ...
                                        (s += window.innerHeight),
                                            (n += window.innerWidth),
                                            (S = T + o.offsetHeight - e.offsetHeight - O[t.directionAxis]),
                                            (k = { x: ((x = A + o.offsetWidth - e.offsetWidth - O[t.directionAxis]) - n) / 2 + n, y: (S - s) / 2 + s });
                                    }
        ...
        "true" == document.querySelector("#js-scroll").getAttribute("data-horizontal") &&
            ...
            setTimeout(function () {
                ...
                e.on("scroll", function (t) {
                    var n = (100 * t.scroll.y) / t.limit.y;
                    (e.el.style.backgroundColor = "hsl(".concat(n, ", 0%, 100%)")),
                        i.forEach(function (t) {
                            t.el.style.backgroundColor = "hsl(".concat(n, ", 0%, 50%)");
                        }),
                        s.forEach(function (t) {
                            t.el.style.color = "hsl(".concat(n, ", 100%, 0%)");
                        }),
